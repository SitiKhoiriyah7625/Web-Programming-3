...
class Booking extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $dtb = $this->ModelBooking->showtemp(['id_user'])->num_rows();
        if ($dtb <1) }
    ...
    public function tambahBooking()
    {
       ...
       if ($databooking > 0) {
           ...
           $this->session->set_flashdata(
               'pesan', 
               '<div class="alert alertdanger alertmessage" role="alert">Masih Ada booking buku sebelumnya yang belum diambil.<br> Abmil Buku yang dibooking atau tunggu 1x24 Jam untuk bisa booking kembali </div>');
            );
            redirect(base_url());
        }
